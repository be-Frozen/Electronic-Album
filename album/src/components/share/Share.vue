<template>
    <div class="content-container" direction="vertical">
        ...
        <el-container v-for="i in 10">
            <el-header class="sharer">
                <img class="profile" src="../../assets/kong.jpg"/>
                <h1 class="message"><span>&nbsp;&nbsp;</span>单机朋友圈？一个人都没有</h1>
            </el-header>
            <el-main class="pic">
                <el-space wrap style="float:left;">
                <img class="shareimg" decoding="async" src="../../assets/share.jpg">
                </el-space>

                <el-space wrap style="float:left;">
                <img class="shareimg" decoding="async" src="../../assets/go.jpg">
                </el-space>
            </el-main>
            <el-footer class="commant">
                ...
                <el-button id="uncomment" @click="comment($event)" style="position: relative;float: left;top: 5px; background-color: transparent;border: none; ">
                    <el-icon choose="false" id="comment" style="pointer-events: none;font-size: 40px;"><Comment /></el-icon>
                    <span choose="false" style="font-size: 24px;color: white;">4</span>
                </el-button>

                <el-button id="unshare" @click="share($event)" style="position: relative;float: left;top: 5px; background-color: transparent;border: none; ">
                    <el-icon choose="false" id="comment" style="pointer-events: none;font-size: 40px;"><Share /></el-icon>
                    <span choose="false" style="font-size: 24px;color: white;">4</span>
                </el-button>


                <div class="comment">
                    <img style="position:absolute;float:left; left: 0; width: 40px;height: 40px;border-radius: 50%;" src="../../assets/ying.jpg"/>
                    <h3 style="position:absolute; left: 55px; top: 15px; float:left; text-align: left">你说的对，但是《原神》是由米哈游自主研发的一款全新开放世界冒险游戏。游戏发生在一个被称作「提瓦特」的幻想世界，在这里，被神选中的人将被授予「神之眼」，导引元素之力‌。你将扮演一位名为「旅行者」的神秘角色，在自由的旅行中邂逅性格各异、能力独特的同伴们，和他们一起击败强敌，找回失散的亲人——同时，逐步发掘「原神」的真相。</h3>
                    <h5 style="position: absolute;right: 0;bottom: 100px; color:pink">2022.11.20 20:13</h5>
                </div>
            </el-footer>
        </el-container>
...
export default {
    ...
    methods : {
        ...
        comment(e){
            if(e.target.getAttribute("id")=="uncomment")
                e.target.setAttribute("id","comment");
            else
                e.target.setAttribute("id","uncomment");
            console.log(e.target.getAttribute("id"));
        },
        share(e){
            if(e.target.getAttribute("id")=="unshare")
                e.target.setAttribute("id","share");
            else
                e.target.setAttribute("id","unshare");
            console.log(e.target.getAttribute("id"));
        },
    }
}
